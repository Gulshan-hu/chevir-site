...
// İşarə barmağı — yalnız işarə barmağı açıq, qalan üçü yumulub.
export const HAND_POSE_POINT = [
  [0, 0, 0],
  [0.25, 0.15, 0.1], [0.36, 0.3, 0.2], [0.32, 0.38, 0.35], [0.24, 0.4, 0.46],
  [0.35, 0.55, 0.05], [0.38, 0.78, 0.05], [0.4, 0.93, 0.04], [0.41, 1.05, 0.03],
  [0.12, 0.6, 0.05], [0.12, 0.68, 0.3], [0.1, 0.62, 0.45], [0.09, 0.53, 0.53],
  [-0.12, 0.58, 0.03], [-0.12, 0.65, 0.28], [-0.11, 0.58, 0.43], [-0.1, 0.5, 0.5],
  [-0.33, 0.5, 0], [-0.32, 0.56, 0.22], [-0.3, 0.5, 0.36], [-0.29, 0.44, 0.43],
]

// Yumruq — bütün barmaqlar ovuca doğru bükülüb.
export const HAND_POSE_FIST = [
  [0, 0, 0],
  [0.25, 0.15, 0.1], [0.38, 0.28, 0.22], [0.3, 0.35, 0.42], [0.18, 0.38, 0.55],
  [0.35, 0.55, 0.05], [0.34, 0.62, 0.28], [0.3, 0.58, 0.42], [0.28, 0.5, 0.5],
  [0.12, 0.6, 0.05], [0.12, 0.68, 0.3], [0.1, 0.62, 0.45], [0.09, 0.53, 0.53],
  [-0.12, 0.58, 0.03], [-0.12, 0.65, 0.28], [-0.11, 0.58, 0.43], [-0.1, 0.5, 0.5],
  [-0.33, 0.5, 0], [-0.32, 0.56, 0.22], [-0.3, 0.5, 0.36], [-0.29, 0.44, 0.43],
]

// Baş barmaq yuxarı — dörd barmaq yumulub, baş barmaq yuxarı açıq.
export const HAND_POSE_THUMBS_UP = [
  [0, 0, 0],
  [0.25, 0.15, 0.1], [0.3, 0.35, 0.15], [0.32, 0.55, 0.12], [0.34, 0.75, 0.1],
  [0.35, 0.55, 0.05], [0.34, 0.62, 0.28], [0.3, 0.58, 0.42], [0.28, 0.5, 0.5],
  [0.12, 0.6, 0.05], [0.12, 0.68, 0.3], [0.1, 0.62, 0.45], [0.09, 0.53, 0.53],
  [-0.12, 0.58, 0.03], [-0.12, 0.65, 0.28], [-0.11, 0.58, 0.43], [-0.1, 0.5, 0.5],
  [-0.33, 0.5, 0], [-0.32, 0.56, 0.22], [-0.3, 0.5, 0.36], [-0.29, 0.44, 0.43],
